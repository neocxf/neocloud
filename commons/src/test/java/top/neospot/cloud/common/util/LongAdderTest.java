...
public class LongAdderTest extends Thread {
    ...
    static {
        try {
            ...
            casOffset = UNSAFE.staticFieldOffset(LongAdderTest.class.getDeclaredField("cas"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void cas() {
        ...
        while (!bl) {
            tmp = cas;
            bl = UNSAFE.compareAndSwapInt(LongAdderTest.class, casOffset, tmp, tmp + 1);
        }
    }
