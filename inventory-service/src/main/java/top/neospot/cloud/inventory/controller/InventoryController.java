...
public class InventoryController {
    ...
    public void updateInventory(@RequestBody ProductInventory productInventory, HttpServletRequest servletRequest) throws Exception {
        InterProcessSemaphoreMutex interProcessSemaphoreMutex = new InterProcessSemaphoreMutex(curatorFramework, "/inventory-cnt-" + productInventory.getProductId());
        ...
        processorThreadPool.dispatch(new ProductInventoryUpdateRequest(productInventory));
        id.incrementAndGet();
    ...
    public ResponseEntity<InventoryItem> findInventoryByProductCode(@PathVariable("productCode") String productCode) {
        ...
        InventoryItem inventoryItem = inventoryItemMapper.selectOne(Wrappers.<InventoryItem>lambdaQuery().eq(InventoryItem::getProductCode, productCode));
    ...
    public Map<String, Object> getInventory() {
        ...
        res.put("inventories", inventoryItemMapper.selectList(null));
